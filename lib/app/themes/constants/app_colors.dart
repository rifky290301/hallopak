...
class AppColors {
  // static Color primary = const Color(0xFF2BA9A7);
  // static Color secondary = const Color(0xFFEEFFFF);
  // static Color borderTextfield = const Color(0xFFCCEAEA);
  // static Color textDisable = const Color(0xFF959595);
  // static Color textEnable = const Color(0xFF3C3C3C);
  // static Color status = const Color(0xFFFFD600);
  // static Color danger = const Color(0xFFFB4B4B);
